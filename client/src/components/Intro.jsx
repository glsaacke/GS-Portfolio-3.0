    ...
    return ( 
        <section className="intro-container container">
            ...
            <div className="intro-info row">
                <span className="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-briefcase-fill" viewBox="0 0 16 16">
            ...
            <div className="intro-links row">
                <a className="resume-btn" href="GSResume.pdf" download="Gavin_Saacke_Resume.pdf">Resume</a>
                <a className="link-btn" href="https://www.linkedin.com/in/gavinsaacke/" target="_blank" rel="noopener noreferrer">
                ...
                <a className="link-btn" href="https://github.com/glsaacke" target="_blank" rel="noopener noreferrer">
